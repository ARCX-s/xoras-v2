...
function showView(id){
  ...
  if(id==='view-sched'&&selGroupName){
    titleEl.style.cssText='font-size:14px;font-weight:800;color:var(--t1);letter-spacing:-.3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;-webkit-text-fill-color:var(--t1);filter:none;background:none';
